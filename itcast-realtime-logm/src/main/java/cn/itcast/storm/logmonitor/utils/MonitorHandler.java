package cn.itcast.storm.logmonitor.utils;

import cn.itcast.storm.logmonitor.dao.LogMonitorDao;
import cn.itcast.storm.logmonitor.domain.*;
import cn.itcast.storm.logmonitor.mail.MailInfo;
import cn.itcast.storm.logmonitor.mail.MessageSender;
import cn.itcast.storm.logmonitor.sms.SMSBase;
...
public class MonitorHandler implements Serializable {
    ...
    public static synchronized void load() {
        ...
        if (userMap == null) {
            // 将应用和应用的负责人关联起来，可以通过appID直接拿到所有的负责人信息。
            userMap = loadUserMap();
        }
    }
