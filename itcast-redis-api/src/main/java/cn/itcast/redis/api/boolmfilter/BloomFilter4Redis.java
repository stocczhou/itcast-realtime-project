 ...
 * Data:     2015/11/16.
 */
public class BloomFilter4Redis<E> implements Serializable {
     ...
     * @param k 使用hash函数的数量
     */
    public BloomFilter4Redis(BitSet bitSet,double c, int n, int k) {
        this.expectedNumberOfFilterElements = n;
        this.k = k;
        this.bitsPerElement = c;
        this.bitSetSize = bitSet.size();
     ...
     */
//    public BloomFilter4Redis(int bitSetSize, int expectedNumberOElements) {
...
//    }
     ...
     */
//    public BloomFilter4Redis(double falsePositiveProbability, int expectedNumberOfElements) {
...
//    }
     ...
     */
//    public BloomFilter4Redis(int bitSetSize, int expectedNumberOfFilterElements, int actualNumberOfFilterElements, BitSet filterData) {
...
//    }
    ...
    public boolean equals(Object obj) {
        ...
        final BloomFilter4Redis<E> other = (BloomFilter4Redis<E>) obj;
